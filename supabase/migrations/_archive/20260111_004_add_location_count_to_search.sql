-- Migration: Add location_count to search results
-- Description: Include count of all locations for multi-location artists in search results
-- Date: 2026-01-11

-- ============================================
-- Update search_artists_by_embedding to include location_count
-- ============================================
...
COMMENT ON FUNCTION search_artists_by_embedding IS
  'Vector similarity search with Pro/Featured ranking boosts. Supports multi-location artists via artist_locations table. Returns location_count for UI badge display.';

-- ============================================
-- Update search_artists_with_count to include location_count
-- ============================================
...
COMMENT ON FUNCTION search_artists_with_count IS
  'Vector similarity search with count and Pro/Featured ranking boosts. Supports multi-location artists. Returns location_count for UI badge display.';
