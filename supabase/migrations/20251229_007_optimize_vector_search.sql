-- Optimize vector search function for performance
-- Improvements: Early filtering, CTE optimization, better indexing

-- ============================================
-- Drop and recreate search function
-- ============================================
...
COMMENT ON FUNCTION search_artists_by_embedding IS
  'Optimized vector similarity search for artists. Filters by city early, uses CTEs for better query planning, and limits results efficiently.';
