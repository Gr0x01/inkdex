-- ============================================================================
-- Migration: Fix update_artist_locations - DROP old 2-param version
-- Date: 2026-01-31
-- Issue: PostgreSQL function overloading - old 2-param version still exists
--        and is being called instead of new 3-param version
-- ============================================================================

-- Drop ALL versions of the function
DROP FUNCTION IF EXISTS update_artist_locations(UUID, JSONB);
DROP FUNCTION IF EXISTS update_artist_locations(UUID, JSONB, UUID);

-- Recreate with proper p_user_id parameter
