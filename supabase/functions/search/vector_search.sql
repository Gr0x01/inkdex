...
--
-- Consolidated Jan 2026: Merged search_artists_by_embedding,
-- search_artists_with_count, and search_artists_with_style_boost into
-- single search_artists function. Style/color params are optional (default NULL).
-- ============================================================================

-- ============================================
-- search_artists
-- Unified vector similarity search function
-- ============================================
...
--
-- Returns all columns including style_boost, color_boost (0.0 when not applicable)
-- ============================================
...
BEGIN
  ...
  -- Step 5: Calculate style boost per artist
  ...
  -- Step 7: Rank images per artist (top 3)
...
COMMENT ON FUNCTION search_artists IS
  'Unified vector similarity search with optional style/color boosts. Returns boosted_score, style_boost, color_boost (0 when not applicable), total_count, and location_count.';
