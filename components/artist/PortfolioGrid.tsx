        ...
        {images.map((image, index) => (
          <div key={image.id} className="contents">
            ...
            <a
              ...
              className="group relative aspect-square overflow-hidden rounded-lg bg-surface-mid border border-border-subtle hover:border-border-strong transition-all duration-medium lift-hover"
            >
              <Image
              ...
              {/* Hover scale effect */}
              <div className="absolute inset-0 group-hover:scale-105 transition-transform duration-medium" />
            </a>
