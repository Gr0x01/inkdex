...
// Helper to create location data from city/state
const createLocation = (city: string, state: string) => [
  { id: '1', city, region: state, country_code: 'US', is_primary: true, display_order: 0 }
];
  ...
  render: (args, { loaded }) => (
    <ArtistHero
      artist={{
        ...
        locations: createLocation(loaded.artist.city, loaded.artist.state || 'CA'),
  ...
  render: (args, { loaded }) => (
    <ArtistHero
      artist={{
        ...
        name: loaded.artist.name,
        slug: loaded.artist.slug,
        locations: createLocation(loaded.artist.city, loaded.artist.state || 'NY'),
  ...
  render: (args, { loaded }) => (
    <ArtistHero
      artist={{
        ...
        name: loaded.artist.name,
        slug: loaded.artist.slug,
        locations: createLocation(loaded.artist.city, loaded.artist.state || 'TX'),
        shop_name: null,
        bio: null,
        bio_override: null,
  ...
  render: (args, { loaded }) => (
    <ArtistHero
      artist={{
        ...
        locations: createLocation('Los Angeles', 'CA'),
  ...
  render: (args, { loaded }) => (
    <ArtistHero
      artist={{
        ...
        name: loaded.artist.name,
        slug: loaded.artist.slug,
        locations: createLocation(loaded.artist.city, loaded.artist.state || 'FL'),
