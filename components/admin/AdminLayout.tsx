...
import { Activity, Users, LogOut, LayoutDashboard, Workflow, Palette, Megaphone, Server } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/orchestrator', label: 'Orchestrator', icon: Server },
