    ...
    return (
      <div className="max-w-2xl mx-auto text-center">
        <div className="bg-paper border-2 border-border-subtle p-6 sm:p-8 lg:p-10 shadow-md">
          ...
          <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl text-ink mb-2">Finalizing...</h1>
    ...
    return (
      <div className="max-w-2xl mx-auto text-center">
        <div className="bg-paper border-2 border-border-subtle p-6 sm:p-8 lg:p-10 shadow-md">
          ...
          <p className="font-body text-sm sm:text-base text-status-error mb-5 sm:mb-6 max-w-md mx-auto">{error}</p>
  ...
  return (
    <div className="max-w-2xl mx-auto text-center">
      <div className="bg-paper border-2 border-border-subtle p-6 sm:p-8 lg:p-10 shadow-md">
        ...
        <p className="font-mono text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider">Redirecting to dashboard...</p>
      </div>
    </div>
  );
}
...
function CompleteLoadingFallback() {
  return (
    <div className="max-w-2xl mx-auto text-center">
      <div className="bg-paper border-2 border-border-subtle p-6 sm:p-8 lg:p-10 shadow-md">
        <div className="w-12 h-12 sm:w-16 sm:h-16 border-2 border-ink border-t-transparent rounded-full animate-spin mx-auto mb-4" />
        <p className="font-body text-sm sm:text-base text-gray-700">Loading...</p>
      </div>
    </div>
  );
}
